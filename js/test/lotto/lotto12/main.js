...
// 2등 : 5개를 맞추고 틀린 번호 중 하나가 bonus 번호와 일치해야 함
...
// 랜덤 번호들
r[0] = selectNum(); // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
print(r[0]);
print("<br>");
...
while (true) {
    ...
    r[1] = selectNum(); // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
...
while (true) {
    ...
    r[2] = selectNum(); // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
...
while (true) {
    ...
    r[3] = selectNum(); // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
...
while (true) {
    ...
    r[4] = selectNum(); // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
...
while (true) {
    ...
    r[5] = selectNum(); // 1 ~ n 까지 범위내에서 랜덤하게 숫자 하나 뽑아주는 애.
